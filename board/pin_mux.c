...
- {pin_num: '45', pin_signal: PTA7/KBI0_P7/FTM2_FLT2/ACMP1_IN1/ADC0_SE3, label: 'J1[16]/J2[17]/PTA7_D7_ANB1', identifier: PTA7_EY}
- {pin_num: '62', pin_signal: PTA0/KBI0_P0/FTM0_CH0/I2C0_4WSCLOUT/ACMP0_IN0/ADC0_SE0, label: 'J2[2]/PTA0_D8_T0', identifier: BUZ}
...
- {pin_num: '31', pin_signal: PTC1/KBI0_P17/FTM2_CH1/ADC0_SE9, label: 'J2[3]/J3[6]/PTC1_A2_PWM1', identifier: KEY_2}
...
- {pin_num: '46', pin_signal: PTA6/KBI0_P6/FTM2_FLT1/ACMP1_IN0/ADC0_SE2, label: 'J2[15]/PTA6_ANB0', identifier: PTA6_EX}
- {pin_num: '73', pin_signal: PTG1/KBI1_P17, label: 'J3[1]/PTG1_GPIO6', identifier: LED_R}
- {pin_num: '72', pin_signal: PTG2/KBI1_P18, label: 'J3[3]/PTG2_GPIO5', identifier: LED_Y}
- {pin_num: '74', pin_signal: PTG0/KBI1_P16, label: 'J3[5]/PTG0_GPIO7', identifier: LED_G}
...
- {pin_num: '71', pin_signal: PTG3/KBI1_P19, label: 'J4[15]/PTG3_GPIO4', identifier: PTG3}
- {pin_num: '79', pin_signal: PTA5/KBI0_P5/IRQ/TCLK0/RESET_b, label: 'J4[6]/J7[10]/RST_TGTMCU/SW1'}
- {pin_num: '32', pin_signal: PTC0/KBI0_P16/FTM2_CH0/ADC0_SE8, label: 'J3[4]/PTC0_A1', identifier: KEY_1}
- {pin_num: '25', pin_signal: PTC2/KBI0_P18/FTM2_CH2/ADC0_SE10, label: 'J3[8]/PTC2_A3', identifier: KEY_3}
- {pin_num: '24', pin_signal: PTC3/KBI0_P19/FTM2_CH3/ADC0_SE11, label: 'J3[10]/PTC3_A4', identifier: KEY_4}
...
- {pin_num: '34', pin_signal: PTH3/KBI1_P27/I2C1_SDA, label: PTH3_KEY1, identifier: BOARDKEY_1}
- {pin_num: '33', pin_signal: PTH4/KBI1_P28/I2C1_SCL, label: PTH4_KEY2, identifier: BOARDKEY_2}
...
void BOARD_InitPins(void)
{
    ...
    /* Initialize GPIO functionality on pin PTB16 (pin 74) */
    GPIO_PinInit(BOARD_INITPINS_LED_G_GPIO_PORT, BOARD_INITPINS_LED_G_PIN, &LED_G_config);

    gpio_pin_config_t LED_R_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTB17 (pin 73) */
    GPIO_PinInit(BOARD_INITPINS_LED_R_GPIO_PORT, BOARD_INITPINS_LED_R_PIN, &LED_R_config);

    gpio_pin_config_t LED_Y_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
